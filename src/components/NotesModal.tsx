  ...
  useEffect(() => {
   ...
   useEffect(() => {
     if (editorRef.current) {
       const placeholderHTML = '<p class="text-gray-400 italic">Write your thoughts, insights, or reflections here...</p>'
       editorRef.current.innerHTML = content ? renderContent(content) : placeholderHTML
     }
   }, [content, view])
            ...
            <div className="p-8 space-y-6 animate-in fade-in-0 slide-in-from-right-4 duration-300">
              ...
              <div>
                ...
                <div
                  ...
                  className="w-full px-5 py-4 border border-gray-200/60 rounded-2xl bg-white text-gray-900 placeholder-gray-400 resize-none transition-all duration-200 text-base leading-relaxed focus:outline-none min-h-[120px] overflow-hidden font-['Inter','system-ui','-apple-system','sans-serif']"
